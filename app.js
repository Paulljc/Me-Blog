...
app.use(function(req,res,next) {
    req.cookies = new cookies(req,res);//新创建一个cookie放入请求体的request

    //22.解析登录用户的cookies信息
    req.userInfo = {};//在req中新建一个对象

    if ( req.cookies.get('userInfo')) { //在api.js设置的cookie信息 userInfo 内有_id 和
        try{
